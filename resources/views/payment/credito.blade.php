              ...
              <div class="col-md-3 col-lg-6 order-md-last">
                ...
                <div class="col-md-6 col-lg-6 order-md-last">
                   ...
                   <div class="group-control">
                       ...
                       <input type="text" name="totalfinal" class="form-control totalfinal" style="margin-left:-15px ;font-family:aharoni;font-size:2em;background-color:rgb(23, 81, 88);color:rgb(18, 178, 252)" value="{{$total}}" readonly="">
                   </div>  
