            ...
            <div class="container-fluid">
               <div class="row">
                ...
                <div class="navbar-header">
                     ...
                     <form class="navbar-form navbar-left web-sh" method="GET" id="searcho">
                        <div class="form">
                           <input type="text"  name="search" class="form-control search" placeholder="Search for products or companies">
                        </div>
