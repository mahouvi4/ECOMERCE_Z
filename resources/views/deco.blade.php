                        ...
                        <div class="preview">
                           ...
                           <div class="preview-pic tab-content">
                            ...
                            <div class="tab-pane active" id="pic-1">
                                ...
                                <img @foreach ($produit_uniq->images as $item) src="{{asset('produit/'.$item->photos)}}" alt="#" @endforeach />
                          ...
                          <input type="hidden" value="{{$produit_uniq->id}}" id="idproduit">
                           ...
                           <li class="active"><a data-target="#pic-1" data-toggle="tab"><img src="{{asset('produit/'.$item->photos)}}" alt="#" class="elog" style="box-shadow: 0 25px 25px rgba(12, 1, 20, 0.885)"/></a></li>
                           @endforeach
                      ...
                      <div class="right-dit-p">
                        ...
                        <div class="like-list">
                           <ul>
                              ...
                              <li>
                                 <div class="im-b"><img class="" src="{{asset('User/'.$item->profile)}}" alt=""></div>
